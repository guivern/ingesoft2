...
import packentidades.Miembros;
import packentidades.MiembrosPK;
...
public class MiembrosFacadeREST extends AbstractFacade<Miembros> {
    ...
    private MiembrosPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        packentidades.MiembrosPK key = new packentidades.MiembrosPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        packentidades.MiembrosPK key = getPrimaryKey(id);
